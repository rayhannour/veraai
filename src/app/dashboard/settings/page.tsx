...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-10 pb-24">
      ...
      {/* 1. HORIZONTAL TABS */}
      <div className="flex gap-4 border-b border-outline-variant/10 pb-8">
        {settingsGroups.map((tab) => (
          ...
          >
            <i className={`pi ${tab.icon} text-lg ${activeTab === tab.id ? 'text-primary' : ''}`}></i>
            <span className="text-sm font-manrope font-bold uppercase tracking-widest">{tab.name}</span>
          </motion.button>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-12 flex flex-col gap-8">
           <div className="bg-surface-container-low p-12 rounded-[3rem] border border-outline-variant/20 shadow-2xl relative overflow-hidden flex flex-col gap-10">
              <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 relative z-10">
                 
                 {/* Parameter Card 1 */}
                 <div className="flex flex-col gap-6 p-10 bg-surface-container rounded-[2rem] border border-outline-variant/10 shadow-lg">
                 ...
                 {/* Parameter Card 2 */}
                 <div className="flex flex-col gap-6 p-10 bg-surface-container rounded-[2rem] border border-outline-variant/10 shadow-lg relative group overflow-hidden">
              ...
              <div className="mt-12 pt-10 border-t border-outline-variant/10 relative z-10 flex justify-between items-center">
                 <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-3">
                       <span className="w-3 h-3 bg-primary rounded-full animate-pulse shadow-[0_0_10px_var(--color-primary)]"></span>
                       <p className="text-sm font-manrope font-bold text-white uppercase tracking-widest">Protocol Version: 9.4.1</p>
                    </div>
                 ...
                 <div className="flex items-center gap-6">
                    ...
                    <button className="px-10 py-5 bg-gradient-to-br from-primary to-primary-container rounded-2xl shadow-[0_0_30px_rgba(0,229,255,0.3)] hover:shadow-[0_0_60px_rgba(0,229,255,0.6)] hover:scale-105 transition-all text-surface font-manrope font-black text-sm uppercase tracking-widest">Update Monolith</button>
                 </div>
              </div>
           </div>
        </div>

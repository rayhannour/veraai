...
export default function AvatarParentPage() {
  ...
  return (
    <div ref={containerRef} className="flex flex-col h-[100svh] w-full overflow-hidden bg-[radial-gradient(circle_at_center,_var(--color-surface-container)_0%,_var(--color-background)_100%)]">
      ...
      <div className="absolute top-6 left-6 z-[5000] flex items-center gap-6 px-8 py-3 bg-surface-container/40 backdrop-blur-2xl border border-white/10 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      ...
      <AnimatePresence mode="wait">
        {mode === 'repeat' ? (
          ...
          >
            ...
            <div className="w-full lg:w-[30%] h-[50svh] lg:h-full relative z-20">
                <AvatarMarketingPage avatarRef={avatarRef} onAvatarSpeakEnd={handleAvatarSpeakEnd} />
            </div>

            {/* 70% Width Container - Presentation */}
            <div className="w-full lg:w-[70%] h-[50svh] lg:h-full flex flex-col relative z-10">
